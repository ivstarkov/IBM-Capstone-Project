...
def scatter(entered_site,payload):
    ...
    if entered_site=='ALL':
        ...
        fig=px.scatter(filtered_df2[filtered_df2['Launch Site'] == entered_site], x='Payload Mass (kg)', y='class', color='Booster Version Category', title="Success count on Payload mass for site".format(entered_site))
        return fig
